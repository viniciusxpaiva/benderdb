const ViewerControlButtons = () => {
    ...
    <div class="row float-right">
        <div class="dropdown mx-2" data-toggle="tooltip" data-placement="top" title="Molecular representation">
            <button class="btn btn-outline-dark btn-sm dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">representation</button>
        ...
        <div class="dropdown mr-2" data-toggle="tooltip" data-placement="top" title="Molecular representation">
        ...
        <button class="btn btn-outline-dark btn-sm mr-2" onclick="set_background()" data-toggle="tooltip" data-placement="top" title="Background color" >
            <span>
        ...
        <button class="btn btn-outline-dark btn-sm" data-toggle="modal" data-target="#modal-control">
