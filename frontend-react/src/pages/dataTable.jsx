...
const convertedRows = pythonStyleRows.map(row => ({
    uniprot: <a href={"https://www.uniprot.org/uniprotkb/" + row.uniprot} title="Go to UniProt" target="_blank" rel="noopener noreferrer">{row.uniprot}</a>,
    species: row.species,
    disease: row.disease,
                        ...
                        <div className="row">
                            ...
                            <Stack sx={{ width: '100%' }} spacing={2}>
                              <Alert variant="outlined" severity="info">
                                ...
                                <h6><strong>More info can be found at table below and at <a href={"https://alphafold.ebi.ac.uk/"} title="Go to UniProt" target="_blank" rel="noopener noreferrer">AlphaFold</a> webpage.</strong></h6>
                              </Alert>
                            </Stack>
                            </div>
                        </div>
